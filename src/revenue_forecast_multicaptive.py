...
class RevenueForecastMulticaptive:
    ...
    def train_model(self, train_start, train_end):
        ...
        self.multiplicative_model_FIN = seasonal_decompose(
            data_FIN_train["Revenue FIN"], model="multiplicative", period=12
        )
        self.multiplicative_model_IND = seasonal_decompose(
            data_IND_train["Revenue IND"], model="multiplicative", period=12
        )
        self.multiplicative_model_NS = seasonal_decompose(
            data_NS_train["Revenue NS"], model="multiplicative", period=12
        )
        ...
        # Define the seasonality based on all full years found in the train data
        first_year = (
