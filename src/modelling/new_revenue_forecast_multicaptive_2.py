...
class RevenueForecastMulticaptive2:
    ...
    def validate(self, forecast_fin, forecast_ind, forecast_ns, validation_start, validation_end, save_errors=False):
        ...
        result = ForecastUtils.validation_results(validation_data, forecast_fin, forecast_ind, forecast_ns, save_errors=save_errors, model_name='multicaptive_normalized', train_data=self.train_data)
        return result
...
if __name__ == "__main__":
    ...
    # Validating
    service.validate(forecast_fin, forecast_ind, forecast_ns, '2024-10-01', '2025-10-31', save_errors=True)